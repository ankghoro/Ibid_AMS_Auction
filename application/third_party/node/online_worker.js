                ...
                winnerSnapshot.forEach(function(winnerData) {
                  ...
                  http.get(getProxyUrl, function(res){
                      ...
                      res.on('end', function(){
                          ...
                          winPostData = {UnitName:UnitName,Npl:npl,Lot:dataLot.lot,ScheduleId:scheduleId,Schedule:dataLot.date,Type:1,AuctionItemId:dataLot.stock_id,Price:formedPrice,Va:dataLot.VA,Model:dataLot.model,Merk:dataLot.merk,Seri:dataLot.seri,Tipe:dataLot.tipe,Silinder:dataLot.silinder,Tahun:dataLot.tahun,NoPolisi:dataLot.nopol,winnerState:state};
