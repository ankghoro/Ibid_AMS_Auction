      ...
      if (npl == '') {
        if ($('#input_npl').val() == '') {
          ...
          $.ajax({
            ...
            url: "http://charlie.ibid.astra.co.id/backend/service/npl/index.php/detail?NPLNumber="+npl+"&ScheduleId="+scheduleId,
            dataType: "json",
            processData: false,
            contenType: false,
...
function doneCurrentSchedule(id){
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo $this->config->item('ibid_npl');?>/counter/npl/npllostxml", // xmlNplKalah
        success: function(updateDataNpl){}
      });
